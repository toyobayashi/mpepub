(function webpackUniversalModuleDefinition(root, factory) {
	module.exports = factory(require('./xmldom/lib/dom-parser.js'), require('./jszip.js'));
})(window, function(__WEBPACK_EXTERNAL_MODULE__87__, __WEBPACK_EXTERNAL_MODULE__156__) {
  var TextEncoder = require('./text.js').TextEncoder;
  var btoa = function btoa (str) {
    return require('./base64-js/index.js').fromByteArray(new TextEncoder().encode(str));
  }
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "requestAnimationFrame", function() { return function requestAnimationFrame (callback) { return setTimeout(callback, 17) }; });
...
var book_Book = /*#__PURE__*/function () {
  function Book(url, options) {
    ...
    if (typeof options === "undefined" && typeof url !== "string" && (typeof Blob === 'undefined' || url instanceof Blob === false) && url instanceof ArrayBuffer === false) {
      options = url;
      url = undefined;
    }
